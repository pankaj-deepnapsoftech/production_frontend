import { FormControl, FormLabel, Input, Checkbox, Grid, GridItem, Stack } from "@chakra-ui/react";
    ...
    <div>
      ...
      <Grid templateColumns="repeat(4, 1fr)" gap={4}>
        {inputs.map((input, ind) => (
          <GridItem key={ind} p={2} border="1px" borderColor="#a9a9a9" borderRadius="8px">
            <Stack spacing={3}>
              <FormControl>
                <Input
                  isDisabled
